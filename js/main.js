;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Dec 10, 2019 10:30:00").getTime();
		...
		// Display the result in an element with id="demo"
		document.getElementById("dias").innerHTML = dias +" <small>dias</small>";
		document.getElementById("horas").innerHTML = horas + " <small>horas</small> ";
		document.getElementById("minutos").innerHTML = minutos + " <small>minutos</small> ";
		document.getElementById("segundos").innerHTML = segundos + " <small>segundos</small> ";
